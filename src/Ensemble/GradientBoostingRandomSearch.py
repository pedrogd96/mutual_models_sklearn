...
params_grid = {
    'selector__k': [5, 10, X_train.shape[1]],
    'xgb__n_estimators': [40, 120, 190, 400],
    'xgb__learning_rate': np.random.uniform(0.001, 10, 500)
}
...
top30 = results_sorted["params"].apply(pd.Series).head(30)
print(top30)